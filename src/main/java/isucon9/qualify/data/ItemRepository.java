...
public interface ItemRepository extends CrudRepository<Item, Long> {
    ...
    public List<Item> findItems(String status0, String status1, LocalDateTime createdAt, long itemId, int itemsPerPage);

    @Query("SELECT * FROM `items` WHERE `status` IN (:status0, :status1) ORDER BY `created_at` DESC, `id` DESC LIMIT :itemsPerPage")
    public List<Item> findItems(String status0, String status1, int itemsPerPage);
    ...
    public List<Item> findItems(long sellerId, String status0, String status1, String status2, LocalDateTime createdAt, long itemId, int itemsPerPage);
    ...
    public List<Item> findItems(long sellerId, String status0, String status1, String status2, int itemsPerPage);
    ...
    public List<Item> findItems(long userId, String status0, String status1, String status2, String status3, String status4, LocalDateTime createdAt, long itemId, int transactionsPerPage);
    ...
    public List<Item> findItems(long userId, String status0, String status1, String status2, String status3, String status4, int transactionsPerPage);
